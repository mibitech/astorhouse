...
import { Plus, Edit2, Trash2, HelpCircle, Search, Loader2 } from 'lucide-react';
import { useForm } from 'react-hook-form';
import { zodResolver } from '@hookform/resolvers/zod';
import Header from '@/components/layout/Header';
import { useFaq } from '../controllers/useFaq';
import { faqSchema, faqManagementCategories, type FAQ, type FAQFormData } from '../models/faq.types';

export function FaqManagementPage() {
  const { faqs, isLoading, createFaq, updateFaq, deleteFaq } = useFaq();
  ...
  const getCategoryLabel = (category: string) => {
    return faqManagementCategories.find((c) => c.value === category)?.label || category;
  };
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Gerencie as perguntas e respostas frequentes</p>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <Select value={filterCategory} onValueChange={setFilterCategory}>
                  ...
                  <SelectContent>
                    ...
                    {faqManagementCategories.map((category) => (
              ...
              <div className="flex items-end">
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                  ...
                  <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto rounded-2xl">
                    <DialogHeader>
                      <DialogTitle>{selectedFAQ ? 'Editar FAQ' : 'Novo FAQ'}</DialogTitle>
                    </DialogHeader>
                    ...
                    <Form {...form}>
                      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <DialogFooter>
                          ...
                          <Button type="submit">{selectedFAQ ? 'Atualizar' : 'Criar'}</Button>
                        </DialogFooter>
                      </form>
                    </Form>
                  </DialogContent>
