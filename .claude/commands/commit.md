...
**Escopo:** nome da feature ou módulo afetado (ex: `filhotes`, `hotel`, `faq`, `admin`)

**Exemplos:**

```
feat(filhotes): adicionar filtro por raça na listagem pública
fix(admin): corrigir soft delete não recarregando a tabela
chore(deps): atualizar Supabase JS para v2.55
```
