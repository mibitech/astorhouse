...
de WhatsApp Léssie e tem PK textual `id_conversa` usada para dedup, com escrita via chave
`anon`. Não altere essa semântica nem as policies de insert anon sem coordenar com o repo
`workspace-lessie-astorhouse`.
