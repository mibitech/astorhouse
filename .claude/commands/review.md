...
### Regras de Negócio (AstorHouse)

- [ ] Filhotes são **vendidos** com pedigree — sem usar o termo "adoção"
- [ ] **Soft delete** (`is_active=false`), nunca remoção física
- [ ] Mudança em schema/`Leads` sinaliza impacto na assistente Léssie
